# Documentacao do site de prescritores
...
- [Contexto antigo para Claude](archive/legacy-claude-context.md): fotografia da arquitetura anterior;
  nao deve ser usado como fonte de verdade atual.

Documentos permanentes ficam em `docs/`. A raiz conserva apenas arquivos de
entrada do projeto e arquivos exigidos pela Vercel ou pelo npm.
